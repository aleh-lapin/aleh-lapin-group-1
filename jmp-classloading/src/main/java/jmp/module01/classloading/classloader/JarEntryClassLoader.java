package jmp.module01.classloading.classloader;
...
public class JarEntryClassLoader extends URLClassLoader{
	...
	private static String[] pathColeections = {
		"d:",
		"Install",
		"eclipse_ee",
		"JMP",
	...
	public static URL getJarEntry(String jarName) throws IOException {
		final String separartor = System.getProperty("file.separator");
		final String basePatch = Arrays.toString(pathColeections).replaceAll("^\\[|\\]$", "").replace(", ", separartor);
		URL jarUrl = new URL("file", "", basePatch + separartor + jarName);
		return jarUrl;
	}
