...
import jmp.module11.ejb.restapi.persistent.*;
...
public class AccountMessageBodyWriter extends JacksonJsonProvider {

	private static final Logger LOG = Logger.getLogger(AccountMessageBodyWriter.class);
